...
Use Python 3.12 or newer and uv. Once installed, run `uv run pytest -q`; ordinary tests must not need API keys or network access. Live runs are separate, paid experiments.
